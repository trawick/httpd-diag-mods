...
** TODO allow APXS= to be specified
** TODO final CHANGES
** TODO test on Solaris
** TODO test on FreeBSD 9
** TODO document how to build, including how to build on Linux with old gcc that doesn't support thread-specific data
...
** TODO retest everywhere
** TODO build binaries for Windows
** TODO tarballs available, website updates
** TODO announce on users@httpd.apache.org
* 3rd release tasks
** TODO use libunwind automatically?
