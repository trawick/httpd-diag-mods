...
*** TODO Escape nasty stuff in the headers.
*** TODO Fix thread-safety of request-specific data.
*** TODO Add ways to filter out certain logging.
*** DONE Don't compile in the crash handler by default.
*** DONE Back out the exception filter as appropriate.
*** TODO Regression test once original feature is implemented.
*** TODO Report should give the pid of the crashing process.
*** TODO mod_crash should display pid for regression testing.
** Web site
*** TODO Create it!
